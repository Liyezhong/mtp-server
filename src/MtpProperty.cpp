        ...
        mEnumValues(NULL)
{
    ...
    if (defaultValue) {
		...
		std::cout << "unknown type "
                           ...
                           << " in MtpProperty::MtpProperty" << std::endl;
        }
    }
}
...
void MtpProperty::setFormRange(int min, int max, int step) {
    ...
    switch (mType) {
        ...
        case MTP_TYPE_UINT64:
            ...
            break;
        default:
std::cout << "unsupported type for MtpProperty::setRange" << std::endl;
            break;
    }
}
        ...
        int value = *values++;
            switch (mType) {
                ...
                case MTP_TYPE_UINT64:
                    ...
                    break;
                default:
std::cout << "unsupported type for MtpProperty::setEnum" << std::endl;
                    break;
        }
    }
}
...
void MtpProperty::print() {
    ...
    bool deviceProp = isDeviceProperty();
    if (deviceProp)
        std::cout << MtpDebug::getDevicePropCodeName(mCode)
                << " (" << std::hex << mCode << std::dec << ")" << std::endl;
    else
        std::cout << MtpDebug::getObjectPropCodeName(mCode)
                << " (" << std::hex << mCode << std::dec << ")" << std::endl;
std::cout << mType << std::endl;
std::cout << "writeable " << (mWriteable ? "true" : "false") << std::endl;
...
std::cout << "DateTime" << std::endl;
            break;
        default:
std::cout << "form " << mFormFlag << std::endl;
            break;
    }
}
...
void MtpProperty::print(MtpPropertyValue& value, MtpString& buffer) {
    ...
    switch (mType) {
        ...
        case MTP_TYPE_STR:
            ...
            break;
        default:
std::cout << "unsupported type for MtpProperty::print" << std::endl;
            break;
    }
...
void MtpProperty::readValue(MtpDataPacket& packet, MtpPropertyValue& value) {
    ...
    switch (mType) {
	    ...
	    std::cout << "unknown type "
                       ...
                       << " in MtpProperty::readValue" << std::endl;
    }
}
...
void MtpProperty::writeValue(MtpDataPacket& packet, MtpPropertyValue& value) {
    ...
    switch (mType) {
	    ...
	    std::cout << "unknown type "
                       << std::hex << mType << std::dec
                       << " in MtpProperty::writeValue" << std::endl;
    }
}
