...
void MtpObjectInfo::print() {
	std::cout << "MtpObject Info " << mHandle << ": " << mName << std::endl;
    std::cout << "  mStorageID: " << std::hex <<  mStorageID
            << " mFormat: " << mFormat << std::dec
            << " mProtectionStatus: " << mProtectionStatus << std::endl;
    std::cout << "  mCompressedSize: " << mCompressedSize
            << " mThumbFormat: " << std::hex << mThumbFormat << std::dec
            << " mThumbCompressedSize: " << mThumbCompressedSize << std::endl;
    std::cout << "  mThumbPixWidth: " << mThumbPixWidth
            << " mThumbPixHeight: " << mThumbPixHeight << std::endl;
    std::cout << "  mImagePixWidth: " << mImagePixWidth
            << " mImagePixHeight: " << mImagePixHeight
            << " mImagePixDepth: " << mImagePixDepth << std::endl;
    std::cout << "  mParent: " << std::hex << mParent
            << " mAssociationType: " << mAssociationType << std::dec
            << " mAssociationDesc: " << mAssociationDesc << std::endl;
    std::cout << "  mSequenceNumber: " << mSequenceNumber
            << " mDateCreated: " << mDateCreated
            << " mDateModified: " << mDateModified
            << " mKeywords: " << mKeywords << std::endl;
}
